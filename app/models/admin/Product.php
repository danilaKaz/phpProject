...
class Product extends AppModel
{
    ...
    public function uploadImg($name, $wmax, $hmax)
    {
        ...
        $types = array("image/gif", "image/png", "image/jpeg", "image/pjpeg", "image/x-png"); //масса доступных расширений
        ...
        if (!in_array($_FILES[$name]['type'], $types)) {
            $res = array("error" => "Доступные расширения - .gif, .jpg, .png");
            exit(json_encode($res));
        }
     ...
     * @param string $dest путь к сохранению обработанного файла
