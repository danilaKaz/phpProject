...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Новый товар</a></li>
    </ol>
</section>
<!-- /.content-header -->
                ...
                <form action="<?= ADMIN; ?>/product/add" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <textarea name="content" id="editor1" cols="80" rows="10"><?php isset($_SESSION['form_data']['price']) ? $_SESSION['form_data']['price'] : null; ?></textarea>
                        </div>
