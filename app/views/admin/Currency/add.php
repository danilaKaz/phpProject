...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="<?= ADMIN; ?>/currency">Группы валют</a></li>
        <li class="active">Новая валюта</a></li>
    </ol>
</section>
<!-- /.content-header -->
                ...
                <form action="<?= ADMIN; ?>/currency/add" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <input type="text" name="value" class="form-control" id="value" placeholder="Значение" required data-error="Допускаются цифры и дяситичная точка" pattern="^[0-9.]{1,}$">
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
